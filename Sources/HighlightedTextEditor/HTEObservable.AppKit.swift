...
public struct HighlightedTextEditorObservable: NSViewRepresentable, HighlightingTextEditorObservable {
...
public extension HighlightedTextEditorObservable {
    ...
    final class Coordinator: NSObject, NSTextViewDelegate {
        ...
        init(_ parent: HighlightedTextEditorObservable) {
            self.parent = parent
        }
        ...
        public func textDidBeginEditing(_ notification: Notification) {
            ...
            parent.model.text = textView.string
